        ...
        <div className="section-advertising">
            <div className="container">
                ...
                <div className="advertising">
                    ...
                    <div className="advertising_right" style={{backgroundImage: `url(${require('assets/advertising.svg').default})`}}/>
                    <div className="advertising_right advertising_right-mobile" style={{backgroundImage: `url(${require('assets/advertising-mobile.svg').default})`}}/>
                </div>
            </div>
        </div>
    );
